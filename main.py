...
st.markdown("""<h1 style='text-align:center;color:#8000C4;font-family: montserrat;font-size:50px;margin-top:-70px;'>Newsearcher<span style='text-align:center;color:red;'>.</span></h1>""",unsafe_allow_html=True)
...
for row in range(0, count):
    try:
        ...
        with st.beta_expander(f"{row+1}. {data['title'].iloc[row]}"):
            ...
            col1.markdown("""<img style='display: block;width: 70%;' src="{}"><p style="color:red;font-weight:bold">{}</p><a style="color:#8000C4;font-weight:bold;font-family: montserrat;" href={} target=_blank>{}</a>"""
